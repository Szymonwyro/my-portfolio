export default function Home() {
  return (
    <main className="flex flex-col items-center justify-start min-h-screen bg-gradient-to-b from-black to-gray-900 p-8">
      ...
      <div className="mt-8 grid grid-cols-1 md:grid-cols-1 gap-6" style={{ maxWidth: '948px', width: '100%' }}>
        <h1 className="text-center text-white text-5xl font-bold mb-4"> Preferred Tech</h1>
        <div className="mt-4 flex justify-center space-x-8">
          <img src="/photos/python.jpg" alt="Python" className="h-16 w-16 object-contain" />
          <img src="/photos/cpp.jpg" alt="C++" className="h-16 w-16 object-contain" />
          <img src="/photos/react.jpg" alt="React" className="h-16 w-16 object-contain" />
          <img src="/photos/typescript.jpg" alt="TypeScript" className="h-16 w-16 object-contain" />
          <img src="/photos/nextjs.jpg" alt="Next.js" className="h-16 w-16 object-contain" />
          <img src="/photos/git.jpg" alt="Git" className="h-16 w-16 object-contain" />
        </div>
      </div>
    </main>
  );
